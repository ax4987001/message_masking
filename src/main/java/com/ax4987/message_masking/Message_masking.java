...
public class Message_masking {
    ...
    public static void onKeyPress(InputEvent.KeyInputEvent event) {
        ...
        if (Message_masking.keyBinding.isPressed()) {
            ...
            for (EntityPlayer player : Minecraft.getMinecraft().world.playerEntities) playerNames.add(player.getName());
            //
            Minecraft.getMinecraft().displayGuiScreen(new MaskingGui(playerNames));
        }
    }
